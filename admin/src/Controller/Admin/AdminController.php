...
class AdminController extends AbstractController
{
    ...
    /**
     * @Route("/pages-site", name="pages_site")
     */
    ...
    /**
     * @Route("/modify-page/{slug}", name="modify_page")
     */
    ...
    /**
     * @Route("/delete-page/{id}", name="delete_page")
     */
    ...
    /**
     * @Route("/articles-site", name="articles_site")
     */
    ...
    /**
     * @Route("/modify-article/{slug}", name="modify_article")
     */
    ...
    /******************************* EN-TÊTE DU SITE *******************************/
    /**
     * @Route("/header-manage", name="header_manage")
     */
